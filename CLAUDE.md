...
Fractal tasks to convert HCS (High-Content Screening) plate data from microscopes into OME-Zarr format. Supports three microscope systems: PerkinElmer Operetta, Evident ScanR, and Yokogawa CQ3K/CellVoyager.
