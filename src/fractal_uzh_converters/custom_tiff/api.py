"""Python API for custom TIFF converters."""
...
def convert_hcs_tiff(
    *,
    ...
    """Convert a custom HCS TIFF dataset to OME-Zarr.
...
def convert_single_tiff(
    *,
    ...
    """Convert a custom single-image TIFF dataset to OME-Zarr.
