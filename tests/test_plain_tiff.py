"""Tests for the plain TIFF converters (HCS plate and single image)."""

from pathlib import Path

import pytest

from fractal_uzh_converters.plain_tiff import (
...
RAW_DIR = DATA_DIR / "PlainTiff" / "raw"
SNAPSHOT_DIR = DATA_DIR / "PlainTiff" / "snapshots"
